        ...
        <div className="board-column">
          <h4 className="fs-s">
            <ul className="board-list">
              ...
              <li className="board-list-item">
                Delectus sequi excepturi maxime. Temporibus magnam quae aliquam
                harum quam.
              </li>
              <li className="board-list-item">
                Nostrum at maiores earum adipisci reprehenderit autem architecto
        ...
        <div className="board-column">
          <h4 className="fs-s">
            <ul className="board-list">
              ...
              <li className="board-list-item">
                Qui magni, harum debitis totam officiis nesciunt placeat? Ipsam,
                mollitia.
              </li>
              <li className="board-list-item">
